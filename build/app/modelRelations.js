...
exports.default = (models) => {
    const { Usuarios, Tipo_usuarios, Posts_usuario, Posts_comentario, Reservas, Detalle_reserva, Tarifas, Estado_reserva, Campings, Camping_imagenes, Categoria_camping, Caracteristicas_camping, Reviews, Puntaje, Relacion_campo_tarifa, Localidades, Provincias, Paises, Caracteristicas_parcela, Abierto_periodo, Periodo_agua_caliente } = models;
    //Relación de 1 - 1
    //Usuarios
